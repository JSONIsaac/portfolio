  ...
  return (
    ...
    >
      ...
      <h1 className="text-3xl font-medium text-center">
        Yeison Isaac Gomez Castro
      </h1>
      <h2 className="px-8 py-2 text-gray-600 dark:text-gray-400">FrontEnd Developer</h2>
      <section className="flex gap-5 text-3xl mb-8">
        <a
          href="https://github.com/JSONIsaac"
        ...
        <a
          href="https://www.linkedin.com/in/yeison-isaac-gomez-412a77173"
          target="__blank"
        ...
        <article className="flex items-center w-11/12 py-2 sm:p-2 gap-3">
          ...
          <div className="flex flex-col">
            ...
            <a
              ...
              href="mailto:yeisaac19829@gmail.com"
            >
              yeisaac19829@gmail.com
            </a>
          </div>
        </article>
      </section>
      <a href="#" target="__blank" className="h-10 w-40 grid place-content-center font-medium text-slate-50 rounded-2xl mt-10 mb-12 bg-indigo-400 cursor-pointer hover:bg-indigo-500 dark:bg-emerald-500 dark:hover:bg-emerald-600 transition-colors duration-300">
        Download CV
      </a>
    </motion.section>
  );
